...
int main() {
    //string original_re = "[01]{1,2}";
    //string original_re = "([0-9][0-9])*";
    //string original_re = "1";
    //string original_re = "12";
    //string original_re = "([12][34])*";
    ...
    string original_re = "0x[0-9a-fA-F]+";
